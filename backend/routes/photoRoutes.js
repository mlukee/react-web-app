...
router.get('/user', requiresLogin, photoController.listUserPhotos);
...
router.put('/:id/unlike', photoController.unlike);
router.put('/:id/dislike', photoController.dislike);
router.put('/:id/undislike', photoController.undislike);
